...
?><div id="header">
<div id="header_inner">
<div class = "header_widget_area"><?php dynamic_sidebar( 'info' ); ?></div>
		<?php mysite_header(); ?> 
 
<div class="fb-like" data-href="http://way2wellness.com/" data-send="true" data-layout="box_count" data-width="400" data-show-faces="true" data-font="arial"></div>
<div class="signup"><?php dynamic_sidebar( 'SignUp' ); ?></div>
